...
public class TestBam2Var {
	...
	public void testHG01500_exome() {
		...
		String in = "data/HG01500.IBS.exome.MT.bam";
		String out = "output";
		String ref = "data/rcrs.fasta";
		double vaf = 0.1;
		int qual = 30;
        ...
        System.out.println(test);
       assertTrue(test.equals("HG01500.IBS.exome.MT.bam	1-16569		146C	263G	310C	750G	1438G	3107T	4769G	6776C	12957C	15326G	16519C	"));
	}
